...
export function CardDetailView({ card, primaryColor, memberCount }: CardDetailViewProps) {
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-8">
          <div className="flex flex-col items-center rounded-[28px] border border-border/40 bg-[#EAE7DF]/40 p-8 text-center shadow-sm dark:bg-surface-2">
            ...
            <button className="flex w-full items-center justify-center gap-1.5 rounded-[14px] border border-border/40 bg-[#E1DED5]/40 px-4 py-3.5 text-[14px] font-bold text-fg transition-all hover:bg-[#E1DED5]/80 dark:bg-surface">
